        ...
        $.ajax({
            ...
            success: function (res) {
                if (res !=-1) {
                    ...
                    alert("Đề đang được sử dụng, không thể xóa !");
